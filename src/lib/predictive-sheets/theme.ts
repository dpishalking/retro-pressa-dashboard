...
export const PM_FOCUS: Record<string, string> = {
  ...
  "05a_НАДЕЖДА": "Смотрим: выручка, счета · Надежда",
  "05b_АНАСТАСИЯ": "Смотрим: выручка, счета · Анастасия",
  "05c_ЕЛЕНА": "Смотрим: выручка, счета · Елена",
  "05d_ДАРЬЯ": "Смотрим: выручка, счета · Дарья",
  "05e_КРИСТИНА": "Смотрим: выручка, счета · Кристина",
  "05f_КИРА": "Смотрим: выручка, счета · Кира",
  "05g_МАРИЯ": "Смотрим: выручка, счета · Мария"
};
