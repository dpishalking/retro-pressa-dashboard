...
const FALLBACK_FAQ: PartnerFaqItem[] = [
  {
    id: "promo-only",
    question: "Почему нет реферальной ссылки?",
    answer:
      "У Retro Pressa много лендингов и точек входа. Ссылка не гарантирует привязку заказа к партнёру. Единственный рабочий способ — ваш промокод при оформлении заказа (или ручное закрепление менеджером)."
  },
  {
    id: "when-commission",
    question: "Когда начисляется комиссия?",
    answer:
      "Комиссия начисляется после оплаты сделки в Bitrix24, если заказ закреплён за вашим промокодом. До оплаты баланс не растёт."
  },
  {
    id: "payouts",
  ...
  },
  {
    ...
    answer: "Да. Передайте друзьям или клиентам ваш промокод и попросите назвать его при заказе."
  },
  {
    id: "b2b",
    question: "Можно ли искать корпоративных клиентов?",
    answer:
      "Да. Корпоративные заказы тоже учитываются по промокоду. Используйте материалы из раздела «Материалы»."
  },
  {
    id: "cancel-refund",
