...
export const birthDateNewspaperProduct = createProductSeed({
  ...
  presentationGuide:
    "Объясняйте, что мы продаём не бумагу, а момент из прошлого. Подчёркивайте реальность издания, эмоциональный эффект и то, что подарок становится началом разговора, а не предметом на полке.",
  materials: [
    textMaterial(
      "mat-original-newspaper",
      "Ключевые акценты",
      "• Реальная газета или журнал из конкретной даты.\n• Подарок работает как машина времени.\n• Сильнее всего эмоция проявляется за праздничным столом.\n• Главная реакция получателя — удивление и тёплое чувство заботы."
    )
  ],
  questions: [
    {
...
export const lifeBookProduct = createProductSeed({
  ...
  presentationGuide:
    "Говорите, что мы показываем жизнь человека через время. Это не набор фотографий, а ощущение целой эпохи. Особенно сильный эффект подарок даёт для старшего поколения и людей с длинной историей семьи.",
  materials: [
    textMaterial(
      "mat-life-book",
      "Как продавать книгу жизни",
      "• Один год жизни = один газетный блок.\n• Первая страница всегда начинается с даты рождения.\n• Особенно сильна книга для людей 40+ и старше.\n• Главная ценность — ощущение прожитой жизни, а не просто полиграфия."
    )
  ],
  questions: [
    {
...
export const partyPageProduct = createProductSeed({
  ...
  presentationGuide:
    "Снимайте страх клиента тем, что мы делаем выпуск с нуля по его материалам. Упирайте на то, что человек становится героем собственной газеты, а сам подарок вовлекает всех вокруг и быстро превращается в часть праздника.",
  materials: [
    textMaterial(
      "mat-party-page",
...
export const glossyMagazineProduct = createProductSeed({
  ...
  presentationGuide:
    "Продавайте не полиграфию, а ощущение значимости. Подчёркивайте, что это настоящий журнал про человека, а не просто альбом или открытка. Для крупных поводов говорите языком статуса, признания и вау-эффекта.",
  materials: [
    textMaterial(
      "mat-glossy-magazine",
...
export const memoriesBookProduct = createProductSeed({
  ...
  presentationGuide:
    "Подчёркивайте срочность: пока человек может рассказать сам, нужно успеть сохранить его голос, интонацию и детали. Объясняйте, что книга — это не альбом, а живое наследие, которое останется в семье надолго.",
  materials: [
    textMaterial(
      "mat-memories-book",
...
export const familySubscriptionProduct = createProductSeed({
  ...
  presentationGuide:
    "Говорите, что это не подписка на бумагу, а подписка на семейную память. Показывайте, что выпуск можно делать регулярно и что он превращает разрозненные новости и фото в настоящую семейную хронику.",
  materials: [
    textMaterial(
