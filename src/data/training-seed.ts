...
export const lifeStoryProduct = createProductSeed({
  ...
  sortOrder: 2.5,
  description:
    "Интервьюер общается с героем книги и раскрывает его жизненный путь. На основе интервью и собранных семейных материалов выстраивается история и готовится книга.\n\nВ коммерческом предложении «История жизни» два формата: 50–70 страниц — компактная цельная история; 100–120 страниц — более подробная история с большим количеством глав и деталей.\n\nЭто другой продукт, чем «Книга жизни в заголовках газет» (газеты за каждый год жизни) и чем семейное издание (история всей семьи). Герой книги — один человек, даже если дети называют её семейным артефактом.",
  targetAudience:
    "Дети, которые хотят подарить близкому книгу о нём; заказчики книги о человеке как семейного артефакта.",
  clientProblems: "",
  emotions: "",
  purchaseReasons: "1. Подарить близкому книгу о нём.\n2. Создать семейный артефакт.",
  objections: "",
  presentationGuide:
    "Для компактной цельной истории жизни — формат 50–70 страниц. Для более подробной истории с главами и деталями — 100–120 страниц.\n\nКак объяснять клиенту:\nКнига создаётся на основе интервью с героем и собранных семейных материалов. В работу входят личное интервью, сбор материалов, структура истории, подготовка книги и финальный макет. В КП: 50–70 страниц за 920 € с интервью или 100–120 страниц за 1 720 € с интервью. Интервью в обоих случаях: 3 часа по 40 €, всего 120 €.\n\nПоказывать стоимость книги, стоимость интервью и итог отдельно. Печать и доставку внутри этих сумм не обещать — в брифе не зафиксированы.\n\nКороткая формулировка для менеджера:\nМы берём интервью у вашего близкого и на основе его рассказа и семейных материалов создаём книгу о нём.",
  materials: [
    textMaterial(
      "mat-life-story-accents",
      "Ключевые акценты",
      "• Основа — интервью с героем и семейные материалы.\n• Два объёма: 50–70 и 100–120 страниц.\n• Книга отдельно: 800 € или 1 600 €. Интервью: 3 часа × 40 € = 120 €. Итог: 920 € или 1 720 €.\n• В составе работы — финальный макет. Включение печати в цену не подтверждено.\n• Не путать с книгой в заголовках газет, глянцевым журналом и семейным изданием.\n• Цены из персонального КП «История жизни», не как утверждённая витрина."
    ),
    textMaterial(
      "mat-life-story-sales",
      "Что говорить клиенту",
      "Мы создаём книгу на основе интервью с вашим близким и семейных материалов. В этом предложении компактный формат на 50–70 страниц стоит 920 € с интервью, подробный на 100–120 страниц — 1 720 € с интервью. На интервью в обоих вариантах заложено 3 часа."
    )
  ],
  questions: [
    {
