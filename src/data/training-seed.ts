...
export const lifeStoryProduct = createProductSeed({
  ...
  title: "Книга жизни",
  shortDescription:
    "Книга о человеке по интервью: интервьюер записывает историю, из разговора собирается книга. Это не газета по годам жизни.",
  coverImage: "/product-cards/life-book.jpg",
  passingScore: 80,
  sortOrder: 2.5,
  description:
    "Книга жизни — это книга о человеке. Интервьюер берёт интервью у героя или у близких, затем из этого материала делается книга.\n\nЭто другой продукт, чем «Книга жизни в заголовках газет». Там внутри — газеты за каждый год жизни. Здесь внутри — живая история человека его словами, собранная после интервью.\n\nДля отдела продаж важно не путать: если клиент хочет архивные заголовки и годы жизни через газеты — это книга в заголовках. Если хочет сохранить голос, рассказ и биографию человека — это Книга жизни.",
  targetAudience:
  ...
  emotions:
    "1. Человек узнаёт себя в тексте. 2. Семья получает голос и историю, а не только факты эпохи. 3. Книгу потом перечитывают. 4. Это ощущение «мою жизнь записали», а не «мне подарили старые газеты».",
  purchaseReasons:
    "Когда клиент говорит: «хотим записать его историю», «нужна книга о папе/маме», «чтобы остался его голос», «не газеты, а про него».",
  objections:
    "«Это то же самое, что книга в заголовках газет?»\n«Это семейное издание?»\n«Это глянцевый журнал о человеке?»\n«Сколько интервью нужно?»",
  presentationGuide:
    "Сначала отделите от книги в заголовках газет: там год за годом идут газеты, здесь интервьюер записывает человека, и из интервью делается книга.\n\nКак объяснять клиенту:\nМы берём интервью и собираем книгу о человеке — его жизнь его словами. Это не архивные заголовки и не журнал, который пишется «под глянец» без разговора с героем.\n\nКороткая формулировка для менеджера:\nКнига жизни = интервью → книга о человеке. Книга жизни в заголовках газет = газеты по годам жизни.",
  materials: [
    textMaterial(
      "mat-life-story-accents",
      "Ключевые акценты",
      "• Интервьюер берёт интервью, затем из этого делается книга.\n• Продукт о человеке, не о газетной хронике.\n• Не путать с «Книгой жизни в заголовках газет».\n• Не путать с семейным изданием (там история семьи) и с глянцевым журналом о человеке."
    ),
    textMaterial(
      "mat-life-story-sales",
      "Что говорить клиенту",
      "• Мы записываем историю человека и делаем из этого книгу.\n• Если нужны газеты за каждый год жизни — это другой продукт: книга в заголовках газет.\n• Если нужна история семьи целиком — смотрим семейное издание."
    ),
    textMaterial(
  ...
  questions: [
    {
      id: "life-story-q1",
      text: "Клиент: «Нужна книга жизни». Через минуту: «чтобы были газеты за каждый год, как тогда писали». Что это?",
      type: "single",
      sortOrder: 1,
      answers: [
        {
          id: "life-story-q1-a1",
          text: "Книга жизни: интервьюер записывает человека, газеты не нужны",
          isCorrect: false
        },
        {
          id: "life-story-q1-a2",
          text: "Книга жизни в заголовках газет: год за годом архивные газеты, не интервью",
          isCorrect: true
        },
        {
          id: "life-story-q1-a3",
          text: "Семейное издание: всегда про всю семью, даже если просят газеты",
          isCorrect: false
        }
      ]
    },
    {
      id: "life-story-q2",
      text: "Клиент хочет «книгу о папе, чтобы записать, как он рассказывает». С чего начать?",
      type: "single",
      sortOrder: 2,
      answers: [
        {
          id: "life-story-q2-a1",
          text: "Сразу подбирать газеты по годам рождения — это и есть книга жизни",
          isCorrect: false
        },
        {
          id: "life-story-q2-a2",
          text: "Это Книга жизни: интервьюер берёт интервью, из разговора делается книга",
          isCorrect: true
        },
        {
          id: "life-story-q2-a3",
          text: "Предложить глянцевый журнал без разговора с героем — быстрее",
          isCorrect: false
        }
      ]
    },
    {
      id: "life-story-q3",
      text: "Чем Книга жизни не является?",
      type: "single",
      sortOrder: 3,
      answers: [
        {
          id: "life-story-q3-a1",
          text: "Книгой о человеке после интервью",
          isCorrect: false
        },
        {
          id: "life-story-q3-a2",
          text: "Книгой из газет за каждый год жизни / семейным журналом про всех сразу / глянцем без интервью",
          isCorrect: true
        },
        {
          id: "life-story-q3-a3",
          text: "Подарком, который можно вручить семье",
          isCorrect: false
        }
      ]
    }
