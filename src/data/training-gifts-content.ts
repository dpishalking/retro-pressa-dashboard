...
export const giftSiteContent: Record<string, GiftSiteContent> = {
  ...
  "gift-edition": {
    ...
    description:
      "Party Page — газета А4 с тематическими шаблонами, создаётся за 1–2 дня. Журнал — настоящий глянец с нуля, минимум 16 страниц. Контент через анкеты и платформы — клиент не пишет статьи сам.",
    targetAudience:
    ...
    presentationGuide:
      "Срочно и знают тему → Party Page. Масштабный юбилей → журнал. Снимайте страх про тексты — нужны ответы на вопросы. Не хочет собирать материал → редактор-менеджер.",
    sectionImages: {
