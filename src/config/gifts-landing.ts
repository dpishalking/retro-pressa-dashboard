...
export const GIFT_LANDING_ITEMS: GiftLandingItem[] = [
  ...
  },
  {
    ...
    description:
      "Именинник листает год за годом: заголовки, события, атмосфера времени. Можно начать с издания из места, где человек родился. Это не фотоальбом и не интервью — ощущение «моя жизнь была целой эпохой» через газеты.",
  ...
  },
  {
    id: "life-story",
    kind: "core",
    passportId: "PRODUCT_LIFE_STORY",
    number: "07a",
    kicker: "Книга о человеке",
    title: "Книга жизни",
    lead: "Когда одного подарка мало — записываем жизнь человека в книгу: интервью, семейные материалы, его голос на страницах.",
    description:
      "Не газета по годам и не история всей семьи. Интервьюер садится с героем, слышит рассказ, собирает семейные материалы — и из этого рождается книга об одном человеке. Два масштаба в КП: 50–70 страниц — цельная история; 100–120 — подробная книга с главами. Интервью считается отдельной строкой.",
    forWhom: "Детям, которые хотят подарить близкому книгу о нём; семье, которой нужен артефакт об одном человеке, пока он ещё может рассказать.",
    moments: ["большой юбилей", "подарок от детей близкому", "пока ещё рассказывают", "семейный артефакт о человеке"],
  ...
  },
  {
    id: "family-card-deck",
    kind: "core",
    passportId: "PRODUCT_FAMILY_CARD_DECK",
    number: "08a",
    kicker: "Семейная память",
    title: "Семейная колода карт",
    lead: "Семейная история через интервью — 54 карты о людях, событиях, питомцах, местах, традициях и фразах.",
    description:
      "Мы не просим придумать 54 карты. Сначала интервьюер находит сюжеты, затем клиент добавляет к ним фотографии и подписи в Профите. Это не фотокнига, не семейное издание и не «Книга жизни» об одном человеке.",
    forWhom: "Тем, кто хочет подарок всей семье, а не одному герою; когда «у родителей всё есть» и фотографии лежат в телефоне.",
  ...
  },
  {
    id: "pervoe-pismo",
    kind: "core",
    passportId: "PRODUCT_PERVOE_PISMO",
    number: "08b",
    kicker: "Рождение ребёнка",
    title: "Первое письмо",
    lead: "Красивое объявление о рождении: дизайн и адреса можно подготовить заранее, а после родов добавить фото и данные малыша.",
    description:
      "Это не поздравительная газета и не просто открытка. Родители заранее выбирают дизайн и список близких. После рождения добавляют первое фото, имя, дату, рост и вес. Full Service берёт на себя печать, персональные тексты, сборку, марки и почтовую отправку. Digital / DIY — только макет, Print Pack — готовый комплект домой.",
    forWhom: "Будущим родителям, семьям с родственниками в другом городе или стране и тем, кто не хочет после родов заниматься макетами, конвертами и почтой.",
    moments: ["подготовка до родов", "рождение ребёнка", "родственники далеко"],
