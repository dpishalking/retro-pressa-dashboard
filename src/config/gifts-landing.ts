...
export const GIFT_LANDING_ITEMS: GiftLandingItem[] = [
  ...
  },
  {
    ...
    title: "Книга жизни",
    lead: "Интервьюер записывает историю человека — из этого делается книга.",
    description:
      "Это не газета по годам и не семейный журнал. Интервьюер берёт интервью у героя или близких, затем из разговора собирается книга о человеке: его жизнь его словами.",
    forWhom: "Тем, кто хочет сохранить голос и историю конкретного человека, а не архивные заголовки.",
    moments: ["юбилей", "когда важно записать рассказ, пока его рассказывают", "подарок семье"],
    gets: ["интервью", "книга о человеке", "история своими словами, не газетной хроникой"],
    price: "по запросу",
    image: "/training/life-book/diana-kanberg-cover.png",
    gallery: []
  },
