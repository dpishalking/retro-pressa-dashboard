...
export const GIFT_LANDING_ITEMS: GiftLandingItem[] = [
  ...
  },
  {
    ...
    title: "Книга жизни",
    lead: "Интервьюер общается с героем — на основе рассказа и семейных материалов готовится книга.",
    description:
      "Не газета по годам и не история всей семьи. Книга о человеке: личное интервью, сбор материалов, структура, макет. Два объёма в КП: 50–70 или 100–120 страниц. Интервью считается отдельной строкой.",
    forWhom: "Детям, которые хотят подарить близкому книгу о нём; семье, которой нужен артефакт об одном человеке.",
