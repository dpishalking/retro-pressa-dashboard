...
const PLANS: ProductMeaningPlan[] = [
  ...
  },
  {
    ...
    framing: [
      [
        "mapping_note",
        "В КП названа «История жизни». В системе — «Книга жизни».",
        "КП История жизни",
      ],
      [
        "compare_with",
        "Не «Книга жизни в заголовках газет» (газеты за каждый год жизни). Не глянцевый журнал о человеке с нуля. Не семейное издание про всю семью: даже если дети называют книгу семейным артефактом, герой — один человек. Форматы 50–70 и 100–120 стр. — варианты одного продукта.",
        "КП История жизни / Product Hub",
      ],
      [
        "do_not_promise",
        "Не обещать газеты по годам жизни. Не продавать как семейное издание про всю семью. Не обещать срок, печать и доставку внутри сумм КП — в брифе не зафиксированы. Не обещать интервью отдельно от книги. Цены 920 / 1 720 € — из персонального КП «История жизни», не подтверждены как общий витринный прайс.",
        "КП История жизни / Product Hub",
      ],
      [
        "cost_from_sheet",
        "КП «История жизни»: 50–70 стр. книга 800 € + интервью 120 € = 920 €; 100–120 стр. книга 1 600 € + интервью 120 € = 1 720 €. Интервью: 3 часа × 40 €.",
        "КП История жизни",
      ],
    ],
  },
  {
    ...
    sheetNameIncludes: ["семейная колода", "колода карт", "семейные карты"],
    trainingId: "family-card-deck",
    framing: [
      [
        "mapping_note",
        "Bitrix ID / точное CRM-название — UNKNOWN. В системе продукт называется «Семейная колода карт». Не путать с семейным изданием.",
        "бриф семейной колоды",
      ],
      [
        "compare_with",
        "Не обычная колода с 54 фотографиями. Не фотокнига. Не семейный журнал / семейное издание. Не «Книга жизни» по интервью об одном человеке. Не «Книга жизни в заголовках газет». Не автоматический конструктор.",
        "бриф семейной колоды",
      ],
      [
        "do_not_promise",
        "Не говорить, что продукт стоит ровно 100 € — только от 100 €. Не обещать конкретную дату готовности только из «от недели». Не обещать, что доставка входит в 100 €. Не обещать материал, плотность, ламинацию, упаковку, подарочный футляр в базе. Не обещать, что одного интервью всегда достаточно.",
        "бриф семейной колоды",
      ],
      [
        "cost_from_sheet",
        "Семейная колода карт — от 100 €. Входят: 1 интервью, интервьюер, редактор, дизайн, печать, 1 колода из 54 карт, согласование, до 3 раундов правок. Доп. интервью +40 €. Доп. колода +50 €. Доставка отдельно.",
        "бриф семейной колоды",
      ],
    ],
  },
  ...
  },
  {
    ...
    sheetNameIncludes: ["первое письмо", "открытка младенца", "анонс о рождении", "baby announcement", "birth announcement"],
    trainingId: "pervoe-pismo",
    framing: [
      [
        "mapping_note",
        "Bitrix ID / точное CRM-название — UNKNOWN. id pervoe-pismo — slug карточки, не ID в CRM. Алиасы: «Открытка младенца»; «персональный анонс о рождении малыша»; baby announcement / birth announcement — описание категории, не отдельный продукт.",
        "бриф первого письма",
      ],
      [
        "compare_with",
