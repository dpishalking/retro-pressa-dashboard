...
const MINT_BY_PRODUCT: MintPassportContent[] = [
  ...
  },
  {
    ...
    retailPrice: "4",
    retailCurrency: "EUR",
    retailNote: "Факт ops: 4 € / штука. COGS 0,5 евроцента (€0,005) за одну.",
    economyExtra: [["unit_cogs", "0.005", "EUR за 1 шт (0,5 евроцента)"]],
    productionSteps: [
  ...
  },
  {
    ...
    retailCurrency: "EUR",
    retailNote:
      "Retail 3,5 €. COGS 20 евроцентов (€0,20) — факт ops.",
    economyExtra: [["unit_cogs", "0.2", "EUR за 1 шт (20 евроцентов)"]],
    productionSteps: [
