...
function meaningsRows() {
  ...
  return passportKvRows([
    ...
    [
      "what_it_is",
      "Книга о человеке — не альбом, не тост и не подборка газет. Интервьюер разговаривает с героем, раскрывает жизненный путь, собирает семейные материалы. Из живого рассказа выстраивается история: голос, главы, смысл прожитого. Человек становится героем настоящей книги. Два формата КП: 50–70 страниц — компактная цельная история; 100–120 страниц — более подробная книга с главами и деталями.",
      SOURCE,
    ],
    [
      "for_whom",
      "Для детей, которые хотят подарить близкому не вещь, а книгу о нём. Для семей, где пора записать жизнь, пока человек сам может рассказать. Для заказчиков артефакта об одном человеке — не хроника всей семьи и не газета эпохи.",
      SOURCE,
    ],
    [
      "key_idea",
      "Записать жизнь одного человека в книгу: его голос, его путь, вещь, которая остаётся в семье.",
      SOURCE,
    ],
    [
      "how_it_works",
    ...
    [
      "what_we_sell",
      "Не полиграфию «про него», а записанную жизнь одного человека. Основа — интервью с героем и семейные материалы. В КП интервью считается отдельной строкой и входит в итог.",
      SOURCE,
    ],
    [
      "when_to_offer",
      "Когда одного тоста мало и хотят подарить близкому книгу о нём; когда нужен семейный артефакт об одном человеке, пока он ещё может рассказать. 50–70 стр. — компактная цельная история; 100–120 стр. — подробная история с главами и деталями.",
      SOURCE,
    ],
    [
      "pitch_one_paragraph",
      "Когда хочется подарить близкому не вещь, а его жизнь в книге — мы садимся с ним на интервью, собираем семейные материалы и создаём книгу о нём. В работу входят личное интервью, сбор материалов, структура истории, подготовка книги и финальный макет. Компактный формат 50–70 страниц — 920 € с интервью; подробный 100–120 страниц — 1 720 € с интервью. Интервью в обоих случаях: 3 часа по 40 €, всего 120 €.",
      SOURCE,
    ],
    [
      "pitch_short",
