...
const SEED: ProductCogs[] = [
  ...
  },
  {
    ...
    bitrixName: "Оживи",
    sourceTitle: "Оживи Ролик",
    retailPrice: 30,
    cogsTotal: 10.5,
    marginPct: 65,
    lines: [
      { article: "Оживление", amountEur: 1 },
      { article: "Оплата сотруднику", amountEur: 5 },
      { article: "Переделка", amountEur: 5 },
    ],
    notes: [
      "Сумма статей 11 €, в исходнике COGS = €10,50 — оставляем итог из таблицы.",
      "Mint «от 2 €» — другой якорь витрины; здесь модель маржинальности.",
    ],
  },
  {
  ...
  },
  {
    ...
    marginPct: null,
    lines: [],
    notes: ["В «Маржинальность» блока нет — заполнить вручную."],
  },
  {
