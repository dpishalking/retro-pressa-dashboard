...
const COST_BENEFIT_BY_PRODUCT: CostBenefit[] = [
  ...
  },
  {
    ...
    costFromSheet: "Факт: 4 € / штука. COGS 0,5 евроцента (€0,005) за одну.",
    valueVsPrice:
      "Высокая маржа при чеке 4 €. Предлагать после основного продукта: «за небольшую доплату подарок заговорит».",
  },
  {
    ...
    costFromSheet: "Retail 3,5 €. COGS 20 евроцентов (€0,20).",
    valueVsPrice:
